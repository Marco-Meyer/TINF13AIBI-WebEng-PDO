...
<title>PDO - Kontakte</title>
	...
	<div id="contacts-categories-container">
		<div id="letter-container" class="contacts-letter">
			<h2 id="#">#</h2>
			<%
				List<Contact> list0 = DBConnectionManager.selectContactsForUserWithBeginningLetter(request.getUserPrincipal().getName(),"0");// showContact für user dieser session
